...
به همین اسونی تونستیم مقدار قبلی متغیر رو توی همون متغیر بریزیم و یک عملایت جدید انجام بدیم . ولی میتونیم این کار رو خیلی راحت تر انجام بدیم ، یک عملی هست که توی تمام های زبان های برنامه نویسی هستش ، اسم تخصصیش میشه : *augmented assignment operator* حالا حفظم نکردی نکردی این اسمو مهم نیست 😂😂.
...
***خداوکیلی تبدیل این کلمات تخصصی سخته به فارسی : (  . تا جایی که بشه سعی میکنم تبدیلشون بکنم ولی یکجایی نمیشه خدایی .***
